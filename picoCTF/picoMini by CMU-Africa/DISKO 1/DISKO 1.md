...
Challenge Description: "Can you find the flag in this disk image?
...
So, it's straightforward to assume that tools like ["mmls"](https://www.sleuthkit.org/sleuthkit/man/mmls.html) from Sleuth Kit can help search through it.
